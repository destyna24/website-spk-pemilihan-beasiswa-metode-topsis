    ...
    <div class="container"> <!--container-->
      	...
      	<div class="col-lg-8 col-lg-offset-2">
      	  <div class="panel panel-default">
                <div class="panel-heading text-center"style="background-color: darkseagreen;" >
                 <p style="color: white;">Evaluation Matrix (x<sub>ij</sub>)</p> 
                </div>
      ...
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
          <div class="panel panel-default">
          <div class="panel-heading text-center"style="background-color: darkseagreen;" >
                 <p style="color: white;">Rating Kinerja Ternormalisasi (r<sub>ij</sub>)</p> 
                </div>
            <div class="panel-body">
              <table class="table table-striped table-bordered table-hover">
                <thead>
      ...
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
          <div class="panel panel-default">
          <div class="panel-heading text-center"style="background-color: darkseagreen;" >
                 <p style="color: white;">Rating Bobot Ternormalisasi(y<sub>ij</sub>)</p> 
                </div>
            <div class="panel-body">
              <table class="table table-striped table-bordered table-hover">
                <thead>
      ...
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
          <div class="panel panel-default">
            <div class="panel-heading text-center"style="background-color: darkseagreen;" >
                 <p style="color: white;">Solusi Ideal positif (A<sup>+</sup>) Benefit</p> 
                </div>
            <div class="panel-body">
              <table class="table table-striped table-bordered table-hover">
                <thead>
      ...
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
          <div class="panel panel-default">
          <div class="panel-heading text-center"style="background-color: darkseagreen;" >
                 <p style="color: white;">Solusi Ideal negatif (A<sup>-</sup>)</p> 
                </div>
            <div class="panel-body">
              <table class="table table-striped table-bordered table-hover">
                <thead>
      ...
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
          <div class="panel panel-default">
          <div class="panel-heading text-center"style="background-color: darkseagreen;" >
                 <p style="color: white;">Jarak positif (D<sub>i</sub><sup>+</sup>)</p> 
                </div>
            <div class="panel-body">
              <table class="table table-striped table-bordered table-hover">
                <thead>
      ...
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
          <div class="panel panel-default">
          <div class="panel-heading text-center"style="background-color: darkseagreen;" >
                 <p style="color: white;">Jarak positif Jarak negatif (D<sub>i</sub><sup>-</sup>)</p> 
                </div>
            <div class="panel-body">
              <table class="table table-striped table-bordered table-hover">
                <thead>
      ...
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
          <div class="panel panel-default">
          <div class="panel-heading text-center"style="background-color: darkseagreen;" >
                 <p style="color: white;">Nilai Preferensi(V<sub>i</sub>)</p> 
                </div>
            <div class="panel-body">
              <table class="table table-striped table-bordered table-hover">
                <thead>
      ...
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
          <div class="panel panel-default">
          <div class="panel-heading text-center"style="background-color: darkseagreen;" >
                 <p style="color: white;">Nilai Perankingan</p> 
                </div>
            <div class="panel-body">
              <table class="table table-striped table-bordered table-hover">
                <thead>
